...
class PublicUserApiTests(TestCase):
    ...
    def test_create_token_invalid_credentials(self):
        ...
        create_user(
            phone='+001010101010', password="testpass",
            email="test@gmail.com", first_name="Marmik"
        )
        payload = {'phone': '+001010101010', 'password': 'wrong'}
        res = self.client.post(TOKEN_URL, payload)
    ...
    def test_create_token_no_user(self):
        ...
        payload = {'phone': '9090900090', 'password': 'testpass'}
        res = self.client.post(TOKEN_URL, payload)
    ...
    def test_create_token_missing_field(self):
        ...
        res = self.client.post(TOKEN_URL, {'phone': '1212444565', 'password': ''})
        self.assertNotIn('token', res.data)
        self.assertEqual(res.status_code, status.HTTP_400_BAD_REQUEST)
